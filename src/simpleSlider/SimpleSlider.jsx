...
const SimpleSlider = () => {
  ...
  return (
    <>
      <div className=" w-[90%] md:w-[70%] lg:w-[60%] mx-auto mt-[5%] rounded-xl bg-gray-200 p-5 py-10 shadow-2xl shadow-[#415a77] ">
        
        <h2 className="text-3xl ">Simple Slider</h2>
        
        <div className="flex items-center gap-2 overflow-hidden">

          <div
            onClick={handelSlide}
            className="border-2 left rounded-full p-2 flex items-center justify-center active:scale-95 cursor-pointer z-10 bg-white"
          >
